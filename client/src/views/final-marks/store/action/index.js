...
import { GET_STUDENTS, ADD_FINAL_MARKS, ARCHIVE, DELETE_FINAL_MARKS, GET_ALL_DATA, GET_DATA, GET_FINAL_MARKS, RESTORE_FINAL_MARKS, UPDATE_FINAL_MARKS } from './actionTypes'
// ** Get all Data
...
export const getStudents = (periodId, subjectId) => {
  return async dispatch => {
    await axios
      .post(`http://127.0.0.1:8000/api/mark/final-marks-print?period=${periodId}&subject_id=${subjectId}`)
      .then(response => {
        dispatch({
          type: GET_STUDENTS,
