...
// ** Store & Actions
import { getAllData, getData, restoreSchedule } from '../store/action'
  ...
  export const  ErrorToast = ({id}) => (
    <Fragment>
      ...
      <div className='toastify-body alert-danger'>
        ...
        Record deleted  <strong>Oops</strong> <Button.Ripple color='flat-info' onClick = {() => { store.dispatch(restoreSchedule(id)) }}>Undo</Button.Ripple>
        </span>
      </div>
    </Fragment>
  )
