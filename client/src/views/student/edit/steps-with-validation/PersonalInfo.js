          ...
          <Row>
            ...
            <FormGroup tag={Col} md='3'>
              ...
              <Select
                ...
                id='maritalState'
                name='maritalState'
                defaultValue={maritalStateOptions[maritalStateOptions.findIndex(el => el.label === selectedStudent.marital_status)]}
            ...
            <FormGroup tag={Col} md='3'>
              ...
              <Select
                ...
                id='gender'
                name='gender'
                defaultValue={genderOptions[genderOptions.findIndex(el => el.label === selectedStudent.gender)]}
                classNamePrefix='select'
            ...
            <FormGroup tag={Col} md='3'>
              ...
              <Select
                ...
                id='language'
                name='language'
                defaultValue={languageOptions[languageOptions.findIndex(el => el.label === selectedStudent.native_tongue)]}
                classNamePrefix='select'
